...
public abstract class UITweener : IgnoreTimeScale
{
	...
	public float BackFactor = 1.70158f;
	...
	public void Sample (float factor, bool isFinished)
	{
		...
		else if (method == Method.BackIn)
		{
			val = val * val * ((BackFactor + 1) * val - BackFactor);
		}
		else if (method == Method.BackOut)
		{
			val = val - 1;
			val = val * val * ((BackFactor + 1) * val + BackFactor) + 1;
		}
